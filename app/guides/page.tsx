...
export const metadata: Metadata = { title: "New Zealand camping and road trip guides", description: "Road trip routes, camping rules, practical planning advice and KiwiCamping tutorials for travelling New Zealand.", alternates:{canonical:"/guides"} };
